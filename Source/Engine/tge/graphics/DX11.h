...
public:
	...
	static void SetDepthEnabled(bool aEnabled);
	static bool IsDepthEnabled() { return myDepthCurrentlyEnabled; }
...
private:
	...
	ComPtr<ID3D11DepthStencilState> myDepthEnabledState;
	ComPtr<ID3D11DepthStencilState> myDepthDisabledState;

	static ID3D11DepthStencilState* DepthEnabledState;
	static ID3D11DepthStencilState* DepthDisabledState;
	static bool myDepthCurrentlyEnabled;
